...
(
    const fvMesh& mesh, const dictionary& dict,  const compressibleMomentumTransportModel& turb, scalar F
)
{
    ...
    return autoPtr<efficiencyFunction>(cstrIter()(dict, mesh, turb, F));
}
