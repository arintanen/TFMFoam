...
thickenedUnityLewisFourier<BasicThermophysicalTransportModel>::thickenedUnityLewisFourier
(
...
thickenedUnityLewisFourier<BasicThermophysicalTransportModel>::q() const
{
...
template<class BasicThermophysicalTransportModel>
tmp<fvScalarMatrix>
thickenedUnityLewisFourier<BasicThermophysicalTransportModel>::
